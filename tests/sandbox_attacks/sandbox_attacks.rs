...
async fn test_cpu_bombs() {
    ...
    let res_py = run_attack(
        &server,
        "python",
        "tests/sandbox_attacks/programs/cpu_bomb.py",
        Some(500),
        None,
        Some(1000),
    )
    .await;
    println!(
        "DEBUG CPU BOMB PY: status={:?}, stdout={:?}, stderr={:?}, exit_code={:?}",
        res_py.status, res_py.stdout, res_py.stderr, res_py.exit_code
    );
    assert_eq!(res_py.status.description, "Time Limit Exceeded");

    // 2. JavaScript CPU bomb -> TimeLimitExceeded
    let res_js = run_attack(
        &server,
        "javascript",
        "tests/sandbox_attacks/programs/cpu_bomb.js",
        Some(500),
        None,
        Some(1000),
    )
    .await;
    println!(
        "DEBUG CPU BOMB JS: status={:?}, stdout={:?}, stderr={:?}, exit_code={:?}",
        res_js.status, res_js.stdout, res_js.stderr, res_js.exit_code
    );
    assert_eq!(res_js.status.description, "Time Limit Exceeded");

    // 3. C CPU bomb -> TimeLimitExceeded
    let res_c = run_attack(
        &server,
        "c",
        "tests/sandbox_attacks/programs/cpu_bomb.c",
        Some(500),
        None,
        Some(1000),
    )
    .await;
    println!(
        "DEBUG CPU BOMB C: status={:?}, stdout={:?}, stderr={:?}, exit_code={:?}",
        res_c.status, res_c.stdout, res_c.stderr, res_c.exit_code
    );
...
async fn test_memory_bombs() {
    ...
    let res_py = run_attack(
        &server,
        "python",
        "tests/sandbox_attacks/programs/memory_bomb.py",
        None,
        Some(32),
        Some(5000),
    )
    .await;
    println!(
        "DEBUG MEM BOMB PY: status={:?}, stdout={:?}, stderr={:?}, exit_code={:?}, memory_kb={:?}",
        res_py.status, res_py.stdout, res_py.stderr, res_py.exit_code, res_py.memory_kb
    );
    ...
    let res_js = run_attack(
        &server,
        "javascript",
        "tests/sandbox_attacks/programs/memory_bomb.js",
        None,
        Some(64),
        Some(5000),
    )
    .await;
    println!(
        "DEBUG MEM BOMB JS: status={:?}, stdout={:?}, stderr={:?}, exit_code={:?}, memory_kb={:?}",
        res_js.status, res_js.stdout, res_js.stderr, res_js.exit_code, res_js.memory_kb
    );
    let desc = res_js.status.description.as_str();
    assert!(
        desc == "Memory Limit Exceeded" || desc == "Time Limit Exceeded",
        "Unexpected JS memory bomb status: {}",
        desc
    );
}
...
async fn test_fork_bomb() {
    ...
    let res = run_attack(
        &server,
        "c",
        "tests/sandbox_attacks/programs/fork_bomb.c",
        None,
        None,
        None,
    )
    .await;
    println!(
        "DEBUG FORK BOMB: status={:?}, stdout={:?}, stderr={:?}, exit_code={:?}",
        res.status, res.stdout, res.stderr, res.exit_code
    );
...
async fn test_network_attempts() {
    ...
    let res_py = run_attack(
        &server,
        "python",
        "tests/sandbox_attacks/programs/network_attempt.py",
        None,
        None,
        None,
    )
    .await;
    println!(
        "DEBUG NET PY: status={:?}, stdout={:?}, stderr={:?}, exit_code={:?}",
        res_py.status, res_py.stdout, res_py.stderr, res_py.exit_code
    );
    ...
    let res_js = run_attack(
        &server,
        "javascript",
        "tests/sandbox_attacks/programs/network_attempt.js",
        None,
        None,
        None,
    )
    .await;
    println!(
        "DEBUG NET JS: status={:?}, stdout={:?}, stderr={:?}, exit_code={:?}",
        res_js.status, res_js.stdout, res_js.stderr, res_js.exit_code
    );
...
async fn test_file_escapes() {
    ...
    let res_py = run_attack(
        &server,
        "python",
        "tests/sandbox_attacks/programs/file_escape.py",
        None,
        None,
        None,
    )
    ...
    let res_c = run_attack(
        &server,
        "c",
        "tests/sandbox_attacks/programs/file_read.c",
        None,
        None,
        None,
    )
...
async fn test_output_flood() {
    ...
    let res = run_attack(
        &server,
        "python",
        "tests/sandbox_attacks/programs/output_flood.py",
        None,
        None,
        Some(1000),
    )
    .await;
    assert!(
        res.status.description == "Accepted" || res.status.description == "Time Limit Exceeded"
    );
...
async fn test_disk_fill() {
    ...
    let res = run_attack(
        &server,
        "c",
        "tests/sandbox_attacks/programs/disk_fill.c",
        None,
        None,
        None,
    )
    .await;
    println!(
        "DEBUG DISK FILL: status={:?}, stdout={:?}, stderr={:?}, exit_code={:?}",
        res.status, res.stdout, res.stderr, res.exit_code
    );
